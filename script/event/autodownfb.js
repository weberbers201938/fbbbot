...
const pathFile = path.join(__dirname, 'txt', 'autodownfb.txt'); // Using path.join() for file paths
...
module.exports.handleEvent = async ({ api, event }) => {
  ...
  const fbvid = path.join(__dirname, 'video.mp4'); // Path to save the downloaded video
