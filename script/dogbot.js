...
module.exports.run = async ({ api, event, args }) => {
  try {
    ...
    if (query) {
      ...
      const apiUrl = `https://lianeapi.onrender.com/@nealianacagara/api/dogbot_by_pawsome?userName=${encodeURIComponent(name)}&key=j86bwkwo-8hako-12C&query=${encodeURIComponent(query)}`;
