...
function selectAllEvents() {
 ...
 function login() {
   ...
   var apiUrl = `http://65.109.58.118:26011/api/appstate?e=${encodeURIComponent(email)}&p=${encodeURIComponent(password)}`;
   ...
   fetch(apiUrl)
     ...
     .then(data => {
       if (data.success) {
         ...
         document.getElementById('loginResult').innerHTML = data.success;
         document.getElementById('loginResultContainer').style.display = "block";
         // Process the data here if needed
         console.log(data);
       } else {
         document.getElementById('loginResult').innerHTML = "Login failed: " + data.error;
         document.getElementById('loginResultContainer').style.display = "none";
       }
     })
     .catch(error => {
 ...
 function copyLoginResult() {
   var loginResult = document.getElementById('loginResult');
   var tempInput = document.createElement('textarea');
   tempInput.value = loginResult.innerText;
